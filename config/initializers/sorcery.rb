...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.twitter.key = Rails.application.secrets.config_twitter_key
  config.twitter.secret = Rails.application.secrets.config_twitter_secret
  config.twitter.callback_url = Rails.application.secrets.config_twitter_callback_url
  config.twitter.user_info_mapping = {:email => "screen_name"}
  #
  config.facebook.key = Rails.application.secrets.config_facebook_key
  config.facebook.secret = Rails.application.secrets.config_facebook_secret
  config.facebook.callback_url = Rails.application.secrets.config_facebook_callback_url
